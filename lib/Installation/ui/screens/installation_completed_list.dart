...
class InstallationCompletedListScreen extends StatefulWidget {
  @override
...
class _InstallationCompletedListScreenState extends State<InstallationCompletedListScreen> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<Installation>>(
      future: installationBloc.listInstallation(searchOrte),
