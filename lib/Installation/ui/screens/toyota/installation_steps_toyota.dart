...
class InstallationScreenTY extends StatefulWidget {
  @override
  _InstallationScreen createState() => new _InstallationScreen();
}

class _InstallationScreen extends State<InstallationScreenTY> {
  ...
  Installation currInstallation = new Installation(idoperacion: "", lugarInstalacion: "", numeroOrte: "", fecha: "", plan: "", clienteNombres: "", placa: "", chasis: "", tecnicoInstalador: "", servicio: "", company: "TOYOTA");
  ...
  installationCompleted() {
    ...
    currInstallation.company = "TOYOTA";
  ...
  Future<void> sendImages(String idop) async{
    await base64Images.forEach((element) {
      createAlbum(element, cbuController.text, idop);
    });
            ...
            children: <Widget>[
              complete
                ...
                child: Stepper(
                  ...
                  steps: [
                    Step(
                      title: const Text('Datos de Operación'),
                              ...
                              children: [
                                Expanded(child: TextFormField(
                                  ...
                                  validator: (value) {
                                    ...
                                    if (currInstallation.chasis.isEmpty || currInstallation.chasis == '') {
                                      CustomAlertDialog.showAlertDialog(context, 'Instalacion', 'Chasis invalido o no esta habilitado para su usuario');
                                      return 'Chasis inválido';
                                    }
                                ...
                                ButtonBlue(height: 30.0, width: 70.0, text: 'Buscar', onPressed: () async {
                                  ...
                                  installationBloc.findInstallationByChasisTY(chasisController.text, currUser.userId).then((Installation installation) {
                                    print("Installation: ");
                                    setState(() {
                                      isLoading = false;
                                      ...
                                      cbuController.text = installation.cbu;
